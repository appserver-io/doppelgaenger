...
/**
 * AppserverIo\Doppelgaenger\Entities\Annotations\Joinpoints\AfterReturning
 *
 * Annotation class which is used to specify "after returning" advice usage
 *
 * @category   Library
 * @package    Doppelgaenger
 * @subpackage Entities
...
class AfterReturning
{
     ...
     * @var string
     */
    const ANNOTATION = 'AfterReturning';
