...
```php
require_once "<PATH_TO_VENDOR>/appserver-io/doppelgaenger/src/Bootstrap.php";
```
 ...
 * @ensures $dgResult instanceof StackElement
 */
public function pop()
{
...
- Support/surveillance of `@var` annotation as basic type safety for properties
- `phpDocumentor<http://www.phpdoc.org/>` support for custom annotations
- Additional syntax for specifying arrays of a certain type (`\Type[]`)
